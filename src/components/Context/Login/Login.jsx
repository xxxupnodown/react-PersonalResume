            ...
            <div className="loginDrop">
                <div className="login">
                    <div className="login-nav">
                        <div><NavLink activeClassName="activeLogin" to="/login/dl">登录</NavLink></div>
                        <div><NavLink activeClassName="activeLogin" to="/login/zc">注册</NavLink></div>
                    </div>
                    <Switch>
...
function Dl() {
    ...
    return (
        <div className="loginForm">
            ...
            <input className="login-input" ref={username} placeholder="请输入用户名" type="text"></input>
            <input className="login-input" ref={password} placeholder="请输入密码" type="password"></input>
            <ul>
                <li>忘记密码?</li>
            </ul>
            <input className="login-submit" type="button" value="登         录" />
        </div>
    )
}
...
function Zc() {
    return (
        <div className="loginForm">
            <input className="login-input" type="text" placeholder="请输入用户名"></input>
            <input className="login-input" placeholder="请输入密码" type="password"></input>
            <input className="login-input" placeholder="确认密码" type="password"></input>
            <input className="login-submit" type="button" value="注         册" />
        </div>
    )
}